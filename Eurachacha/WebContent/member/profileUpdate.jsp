	...
	<div class="container"
		...
		<div>
			<form name="form" method="POST"
				action="<c:url value='/member/update' />" class="needs-validation"
				novalidate name="profileUpdate">
				<div class="row">
					<div class="col-md-12">
				...
				<div style="text-align: center;">
					<button class="btn btn-primary btn-dark" id="buttons" type="button"
						style="width: 20%" onClick="memberUpdate()">수정</button>
					&nbsp; &nbsp;
					<button class="btn btn-primary btn-secondary" id="buttons"
					type="submit" style="width: 20%"
					onClick="noUpdate('<c:url value='/member/profile?memberId=${member.member_id}'/>')">취소</button>
				</div>
			</form>	
		</div>
	</div>
